...
function UserProfileEdit() {
  ...
  const handleSubmit = (event) => {
    ...
    if (password !== confirmPassword) {
      ...
      setPasswordError('Password must contain at least 1 capital letter, 1 special character, 1 digit, and be between 7-40 characters long');
    } else {
              ...
              <div className="card-body">
                <form onSubmit={handleSubmit}>
                  <div className="mb-3">
                    ...
                    <input className="form-control" id="inputUsername" type="text" placeholder="Enter username" />
                  </div>
                  <div className="mb-3">
                    <label className="small mb-1" htmlFor="inputEmail">Email address</label>
                    <input className="form-control" id="inputEmail" type="email" placeholder="Enter email address"/>
                  </div>
                  <div className="mb-3">
                  ...
                  <div className="mb-3">
                    <label className="small mb-1" htmlFor="inputConfirm">Confirm Password</label>
                    <input
                      className="form-control"
                      id="inputConfirm"
                      type="password"
                  ...
                  <div className="row gx-3 mb-3">
                    <div className="col-md-6">
                      <label className="small mb-1" htmlFor="inputOrgName">Career Field</label>
                      <input className="form-control" id="inputOrgName" type="text" placeholder="Role/Position"/>
                    </div>
                    <div className="col-md-6">
                      <label className="small mb-1" htmlFor="inputLocation">Location</label>
                      <input className="form-control" id="inputLocation" type="text" placeholder="Enter Address"/>
                    </div>
                  </div>
                  <div className="mb-3">
